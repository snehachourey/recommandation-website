    ...
    <div className="skill-page">
      ...
      <div className="skill-section">
        ...
        <div className="skill-grid">
          ...
          <div className="skill-card">⚙ Technical</div>
      ...
      <div className="skill-section">
        <h3>
          How comfortable are you with public speaking? <span>*</span>
        </h3>

        <div className="skill-grid small">
          <div className="skill-card">😍 Love It</div>
          <div className="skill-card">😨 Nervous</div>
          <div className="skill-card">😞 Don't Like</div>
        </div>
      </div>
